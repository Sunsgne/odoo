...
class ZenlenetTicket(models.Model):
    ...
    flow_state = fields.Selection(related='flow_id.state', string='交付阶段')
    flow_order_id = fields.Many2one(related='flow_id.order_id', string='服务订单')
    flow_resource_ids = fields.One2many(related='flow_id.resource_ids', string='这张工单的资源')
